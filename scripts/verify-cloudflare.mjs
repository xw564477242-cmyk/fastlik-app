...
assert(walletTransferPostChainIntegrationTests.includes("one POST is persisted-confirmed") && walletTransferPostChainIntegrationTests.includes("TRANSACTIONS:BOTH") && walletTransferPostChainIntegrationTests.includes("late success, error, and 401"), "Cloudflare transfer evidence must cover one POST, two-sided resources and stale zero writes");
