...
assert(app.includes("one explicit same-key retry only · activation commits only after real Card GET and Card list GET both confirm ACTIVE"), "Card status UI must state its bounded retry and activation confirmation boundary");
