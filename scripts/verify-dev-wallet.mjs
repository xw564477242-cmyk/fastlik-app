...
assert(app.includes("retryKey??crypto.randomUUID()") && app.includes("Boolean(retryKey)"), "Every Card status click must use one fresh caller-owned UUIDv4 or the one exact retained retry key");
