   ...
   <section className="panel">
    ...
    {selectedAccount&&<>
     ...
     <div className="record-list">
      <h3>Owned account history · {selectedAccount.assetCode}</h3>
