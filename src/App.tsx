...
export default function App(){
 ...
 const acceptSession=async(current:WalletSession)=>{
  ...
  await Promise.all([
   runSessionInitializationModule({load:()=>walletApi.cards(),isCurrent,commit:value=>{cardPage=value;setCards(value.cards);setCardNextCursor(value.nextCursor)},moduleError:()=>setCardListError('Cards unavailable for this session'),sessionInvalid}),
