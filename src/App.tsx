...
export default function App(){
 ...
 const consumerExperience=session?<WalletExperience session={session} accounts={accounts} summary={walletBalanceSummary} operations={walletOperations} transactions={walletTransactions} cards={cards} selectedCard={selectedCard} cardBalance={cardBalance} cardTransactions={cardTransactions} loading={busy} errors={[error,walletBalanceSummaryError,walletError,walletHistoryError,walletOperationsError,cardListError,cardRefreshError,cardBalanceError,cardTransactionError].filter(Boolean)} buildSha={walletRuntime.buildSha} onRefresh={()=>void refresh()} onLogout={()=>void logout()}/>:null
