...
export default function App(){
 ...
 return <main style={{maxWidth:980,margin:'40px auto',padding:24,fontFamily:'Inter,system-ui'}}>
  ...
  {session&&<WalletRenderBoundary resetKey={sessionScope(session)} title="Wallet view unavailable" message="The authenticated Wallet view could not be rendered safely."><div className="wallet-grid">
   ...
   <Phase2WalletPanel accounts={accounts} selectedCardId={selectedCard?.id??null} sessionEnvironment={session.environment} sessionKey={sessionScope(session)}/>
