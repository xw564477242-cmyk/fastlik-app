...
export function WalletExperience(props:Props){
 ...
 return <div className="consumer-wallet">
  <div className="consumer-scroll">
   ...
   {page==='assets'&&<Assets accounts={props.accounts} summary={props.summary} transactions={props.transactions} onConvert={()=>go('convert')}/>} 
