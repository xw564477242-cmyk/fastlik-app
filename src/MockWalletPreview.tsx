...
export function MockWalletPreview() {
  return <main>
    ...
    <Phase2WalletPanel accounts={previewAccounts} selectedCardId="card_mock_physical" sessionEnvironment="SANDBOX" sessionKey="mock-sandbox-session" catalogReadEnabled/>
  </main>
}
